...
class SessionsTest < ApplicationSystemTestCase
  ...
  test "creating a Session" do
    ...
    fill_in "Class date", with: @session.class_date
    fill_in "Class time", with: @session.class_time
    fill_in "Grade", with: @session.grade_id
    fill_in "Subject", with: @session.subject
